  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      ...
      if (tckn === '12345678901' && email === 'ahmet.yilmaz@student.edu.tr') {
        ...
        setError('Girdiğiniz bilgiler sistemdekilerle eşleşmiyor.');
      }
      setLoading(false);
    }, 1000);
  };
    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 flex items-center justify-center p-4 font-sans">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          <div
            className="w-16 h-16 bg-[#C00000] rounded-xl flex items-center justify-center mx-auto mb-4 shadow-lg"
          >
        ...
        <div className="bg-white rounded-2xl shadow-xl p-8 border border-gray-100">
          {success ? (
            <div className="text-center space-y-4">
              ...
              <h2 className="text-xl font-bold text-gray-900">Talimatlar Gönderildi</h2>
              <p className="text-gray-600 text-sm leading-relaxed">
                Eğer girdiğiniz bilgiler sistemdeki kayıtlarımızla eşleşirse, kısa süre içinde şifre sıfırlama bağlantısını e-posta adresinize göndereceğiz.
              </p>
              <div className="pt-4">
                <Button
                  onClick={onBack}
